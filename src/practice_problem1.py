...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        appended_character_number = min(leftover, len(additional_contents))

        stuff_to_add = ''
        for k in range(appended_character_number):
    ...
    def combined_box(self, other_box):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        comboBox = Box(self.contents + other_box.contents, self.volume + other_box.volume)
